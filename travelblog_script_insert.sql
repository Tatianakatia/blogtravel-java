...
insert into post (post_id,title,metaTitle,slug,summary,published,content, user_id)
...
0,"family holiday",1),(2,"Amazing mountains!","winter,travel,view","winter-season","For all snowboarding lover that is the best place! Check my post to see amazing skiing route!",0,"winter holiday",2),
(3,"Lazy holiday!","summer,sea,sunshine","sunny-holiday","If you want to spend all day relaxing in the beach, far away from the other people that is the best place for you! Check in the post where you can hide from everyone!",0,"time for myself",3);

insert into post_meta(post_meta_id,post_Id,meta_key, content)
value (1,1,679,"Video","Learn more"),(2,2,2,"I love this place!"),
